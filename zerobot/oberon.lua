-- Grand Master Oberon Auto-Responder for Zerobot (Corrected)
...
-- Note: To stop this script's functionality, you would typically disable it in the Zerobot UI,
-- which should automatically call Game.unregisterEvent(Game.Events.TALK, oberonTalkHandler).